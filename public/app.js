                ...
                <div class="col s10 push-s1">
                    <div class="row">
                        <div class="col m5 hide-on-small-only">
                            <img src="smartphone.png" class="smartphone" alt="">
                        </div>
                        ${box}
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col s12 m6 offset-m1">
                            <a href="/" class="brand-logo platzigram">Rodrigram</a>
                        </div>
...
},{"intl":25,"intl-relativeformat":19,"intl-relativeformat/dist/locale-data/en.js":17,"intl-relativeformat/dist/locale-data/es.js":18,"intl/locale-data/jsonp/en-US":27,"intl/locale-data/jsonp/es-MX":28,"yo-yo":36}],44:[function(require,module,exports){
var page = require('page');
var empty = require('empty-element');
var template = require('./template');
var title = require('title');
                            ...
                            <div class="signup-box">
                                ...
                                <form action="" class="signup-form">
                                    ...
                                    <div class="section">
                                        ...
                                        <button type="submit" class="btn waves-effect waves-light signup-btn">Iniciar sesion</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                            ...
                            <div class="signup-box">
                                ...
                                <form action="" class="signup-form">
                                    ...
                                    <div class="section">
                                        ...
                                        <input type="text" name="username" placeholder="Nombre de usuario">
                                        <input type="password" name="password" placeholder="Contraseña">
                                        <button type="submit" class="btn waves-effect waves-light signup-btn">Registrate</button>
                                    </div>
                                </form>
                            </div>
                        </div>
